...
myMac.folders = {
    folderJS: ["IdeaProjects", "Web-exercises", "Profile"],
    folderC: ["UnityProjects", "C# Scripts", "Player"],
    folderPython: ["IDLE", "Python", "Scripts"]
};

console.log(myMac.folders.folderC[1]);

myMac.folder = ["IdeaProjects", "UnityProjects", "Codeup"];

console.log(myMac.folder[1]);

function myApps(){
    console.log("These are my apps: ");
    myMac.folder.forEach(function(folder){
        console.log(folder);
    });
...
myMac.login = {
    username: "yummy101",
    fakePassword: "101yummy",
    email: "yummy101@yummy.com"
};
