...
// geocode("9898 Colonnade Blvd #18201, San Antonio, Tx, 78230", mapboxToken).then(function(result) {
//     console.log(result);
...
//TODO: Using the geocode method above, add a marker to address to the map
...
reverseGeocode({lng: 120.9826, lat: 14.5347}, mapboxToken).then(function(results) {
    // logs the address for The Alamo
    console.log(results);
});
